...
/******/ 	var hotCurrentHash = "5f9da292cf5c3e3185a2"; // eslint-disable-line no-unused-vars
...
exports.default = {
    draw: function draw(context, dataSet, options) {
        ...
        var dx = r * 2 * Math.sin(Math.PI / 3); // 水平偏移距离
        var dy = r * 1.5; // 一个蜂窝图的 垂直偏移距离
...
var _line = __webpack_require__(76);
...
exports.__esModule = true;
/**
 * Created by wake on 2017/2/9/009.
 */
/**
 * 一直覆盖在当前地图视野的Canvas对象
 *
...
if (global.IMAP) {
    CanvasLayer = IMAP.Class(LDVector, {
        ...
        _createElement: function _createElement() {
            ...
            if (!this._element && map) {
                if (document.getElementsByClassName("mapvLayer")[0]) {
                    var height = this._height,
                        width = this._width;
                    var canvasLayer = document.getElementsByClassName("mapvLayer")[0];
                    var canvas = LD.Function.createElement({
                        name: "canvas",
                    ...
                    canvasLayer.className = "mapvLayer";
        ...
        show: function show() {
            if (!this.canvas) {
                //this.initialize();
                // ishow采用 IMAP.Class 方法创建类， 在构造函数内会自动调用 initialize方法，
    ...
    console.log("IMAP is not undefined, please import the IMAP API from http://cmapi.ishowchina.com/v3/webapi/js/auth?v=3.3.2&t=jsmap&ak=Your keygen");
}
...
if (global.ol) {
    ...
    CanvasLayer.prototype.adjustSize = function () {
        ...
        canvas.width = size[0] * devicePixelRatio;
        canvas.height = size[1] * devicePixelRatio;
        if (this.context == '2d') {
            canvas.getContext(this.context).scale(devicePixelRatio, devicePixelRatio);
        }
    ...
    /**
     * bind the map Event for drag、zoom、change view
     */
    CanvasLayer.prototype.bindEvent = function () {
        var self = this;
        self._map.getView().on('change:center', self._moveHandler.bind(self));
        // self._map.on('moveend', self._moveHandler.bind(self));
    };

    CanvasLayer.prototype._moveHandler = function (type) {
        this.draw();
    };
}
...
var _version = __webpack_require__(57);
...
var _Flate = __webpack_require__(60);
...
var _resolutionScale = __webpack_require__(61);
...
var _cityCenter = __webpack_require__(73);
...
var _forceEdgeBundling = __webpack_require__(75);
...
var _mapHelper = __webpack_require__(68);
...
var _CanvasLayer2 = __webpack_require__(43);
...
var _Layer2 = __webpack_require__(66);
...
var _CanvasLayer3 = __webpack_require__(44);
...
var _Layer3 = __webpack_require__(67);
...
var _CanvasLayer4 = __webpack_require__(45);

Object.defineProperty(exports, "olMapCanvasLayer", {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_CanvasLayer4).default;
  }
});

var _Layer4 = __webpack_require__(69);

Object.defineProperty(exports, "olMapLayer", {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_Layer4).default;
  }
});
...
var _csv = __webpack_require__(63);
...
var _simple3 = __webpack_require__(27);
...
var _simple5 = __webpack_require__(3);
...
Layer.prototype._canvasUpdate = function (time) {
    ...
    var mcCenter = projection.lngLatToPoint(map.getCenter()); //获取 地图中心点的墨卡托坐标
...
var _CanvasLayer = __webpack_require__(44);
...
Layer.prototype._canvasUpdate = function (time) {
    ...
    var bounds = self.map.getBounds(),
        zoom = map.getZoom(),
        rangeX = _project2.default.scale(zoom); // x 方向上宽度（像素）
...
Layer.prototype.hide = function () {
    ...
    this.canvasLayer._element && this.canvasLayer._element.removeChild(this.canvasLayer.canvas);
};
...
var _CanvasLayer = __webpack_require__(45);
...
Layer.prototype.transferToMercator = function () {
    //var projection = this.map.getMapType().getProjection();
    var self = this;
    if (this.options.coordType !== 'olmc') {
        var data = this.dataSet.get();
        data = this.dataSet.transferCoordinate(data, function (coordinates) {
            var mcPoint = ol.proj.transform(coordinates, 'EPSG:4326', 'EPSG:3857');
            return mcPoint;
        }, 'coordinates', 'coordinates_mercator');
        this.dataSet._set(data);
    }
...
Layer.prototype._canvasUpdate = function (time) {
    ...
    var mcCenter = map.getView().getCenter(); //获取 地图中心点的墨卡托坐标
    var resolution = map.getView().getResolution();
    var nwMc = {
        x: mcCenter.x - map.getSize().width / 2 * resolution,
        y: mcCenter.y + map.getSize().height / 2 * resolution
    }; //左上角墨卡托坐标
    ...
    var dataGetOptions = {
        fromColumn: self.options.coordType == 'olmc' ? 'coordinates' : 'coordinates_mercator',
        transferCoordinate: function transferCoordinate(coordinates) {
            var mcPoint = map.getPixelFromCoordinate(coordinates);
            return mcPoint;
        }
    };
    ...
    switch (self.options.draw) {
        ...
        case 'honeycomb':
            /*
             ...
             var nwPixel = map.pointToPixel(new BMap.Point(minx, maxy));
             */
            var nwPixel = map.getPixelFromCoordinate(ol.proj.transform([0, 0], 'EPSG:4326', 'EPSG:3857'));
            self.options.offset = {
                x: nwPixel[0],
                y: nwPixel[1]
            };
...
exports.default = {
    lonLat2Mercator: function lonLat2Mercator(lng, lat) {
        ...
        var e = Math.PI / 180,
            n = Math.max(Math.min(MAX_LATITUDE, lat), -MAX_LATITUDE),
            s = Math.sin(n * e);
